...
#     def display(self):
#         print(f"Book id is {self.book_id}, Title is {self.title}, Author name is {self.author},Status is {self.Is_issued}")
...
#         self.UserId=UserId
#         self.name=name
#         self.borrowed_List=[]   # empty list 
    
#     def display(self):
#         print(f"User id is {self.UserId}, Name is {self.name},Borrowed List is {self.borrowed_List}")  # for printing whole list 
...
#             self.userList.append(user)    # add user in userlist 


#     def addBook(self,B):
#         self.booksList.append(B)  #b as book obj store in booklist 
...
#         for user in self.userList:
#             if user.UserId == key or user.name==key:
#                 return user
...
#         for book in self.booksList:
#             if book.book_id == key or book.title==key or book.author==key:
#                 return book
...
#         elif choice == "5":
#             key = input("Enter User ID or Name: ")
...
#         elif choice == "7":
#             print("Total Books:", library.bookCount())
#             input("\nPress Enter to continue...") 
#             pause()
            

#         elif choice == "8":
#             print("Total Users:", library.UserCount())
#             input("\nPress Enter to continue...") 
#             pause()
